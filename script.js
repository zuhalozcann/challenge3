...
document.getElementById("california").onclick = function(){
	...
	document.getElementById('landingsplaats').src = "../Challenge-3-Zuhal-Ozcan/images/1.jpg";
	date();
...
document.getElementById("tenessee").onclick = function(){
	...
	document.getElementById('landingsplaats').src = "../Challenge-3-Zuhal-Ozcan/images/3.jpg";
